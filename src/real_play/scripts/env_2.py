...
if __name__ == "__main__":
    ...
    big_box_centers = [
        (-0.255, -0.655, 0.155 + 0.75),
        (0.255, -0.655, 0.155 + 0.75),
        (0.255, -0.655, 0.465 + 0.75),
        (0.255, -0.655, 0.775 + 0.75),
        (-0.055, -0.655, 0.775 + 0.75)
    ]
    ...
    for center in small_box_centers:
        obstacles.append((list(center), small_box_size, blue))
    
    # 调用发布函数
    publish_env("env_2", obstacles, 0.75)
