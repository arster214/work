...
(cl:defmethod cl:initialize-instance :after ((m <ChangeTool_Name>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChangeTool_Name)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<ChangeTool_Name> is deprecated: use dual_arm_msgs-msg:ChangeTool_Name instead.")))

(cl:ensure-generic-function 'toolname-val :lambda-list '(m))
(cl:defmethod toolname-val ((m <ChangeTool_Name>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:toolname-val is deprecated.  Use dual_arm_msgs-msg:toolname instead.")
  (toolname m))
