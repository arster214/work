...
(cl:defmethod cl:initialize-instance :after ((m <Tool_Digital_Output>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tool_Digital_Output)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Tool_Digital_Output> is deprecated: use dual_arm_msgs-msg:Tool_Digital_Output instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Tool_Digital_Output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:num-val is deprecated.  Use dual_arm_msgs-msg:num instead.")
  (num m))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <Tool_Digital_Output>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:state-val is deprecated.  Use dual_arm_msgs-msg:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Tool_Digital_Output>)))
  ...
  "dual_arm_msgs/Tool_Digital_Output")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Tool_Digital_Output)))
  "Returns string type for a message object of type 'Tool_Digital_Output"
  "dual_arm_msgs/Tool_Digital_Output")
