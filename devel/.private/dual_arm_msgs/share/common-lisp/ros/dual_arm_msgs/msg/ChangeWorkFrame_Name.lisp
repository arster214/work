...
(cl:defmethod cl:initialize-instance :after ((m <ChangeWorkFrame_Name>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChangeWorkFrame_Name)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<ChangeWorkFrame_Name> is deprecated: use dual_arm_msgs-msg:ChangeWorkFrame_Name instead.")))

(cl:ensure-generic-function 'WorkFrame_name-val :lambda-list '(m))
(cl:defmethod WorkFrame_name-val ((m <ChangeWorkFrame_Name>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:WorkFrame_name-val is deprecated.  Use dual_arm_msgs-msg:WorkFrame_name instead.")
  (WorkFrame_name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ChangeWorkFrame_Name>)))
  ...
  "dual_arm_msgs/ChangeWorkFrame_Name")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ChangeWorkFrame_Name)))
  "Returns string type for a message object of type 'ChangeWorkFrame_Name"
  "dual_arm_msgs/ChangeWorkFrame_Name")
