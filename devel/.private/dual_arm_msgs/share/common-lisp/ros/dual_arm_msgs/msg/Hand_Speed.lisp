...
(cl:defmethod cl:initialize-instance :after ((m <Hand_Speed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hand_Speed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Hand_Speed> is deprecated: use dual_arm_msgs-msg:Hand_Speed instead.")))

(cl:ensure-generic-function 'hand_speed-val :lambda-list '(m))
(cl:defmethod hand_speed-val ((m <Hand_Speed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:hand_speed-val is deprecated.  Use dual_arm_msgs-msg:hand_speed instead.")
  (hand_speed m))
