...
(cl:defmethod cl:initialize-instance :after ((m <Joint_Max_Speed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joint_Max_Speed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Joint_Max_Speed> is deprecated: use dual_arm_msgs-msg:Joint_Max_Speed instead.")))

(cl:ensure-generic-function 'joint_num-val :lambda-list '(m))
(cl:defmethod joint_num-val ((m <Joint_Max_Speed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:joint_num-val is deprecated.  Use dual_arm_msgs-msg:joint_num instead.")
  (joint_num m))

(cl:ensure-generic-function 'joint_max_speed-val :lambda-list '(m))
(cl:defmethod joint_max_speed-val ((m <Joint_Max_Speed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:joint_max_speed-val is deprecated.  Use dual_arm_msgs-msg:joint_max_speed instead.")
  (joint_max_speed m))
