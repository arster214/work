...
(cl:defmethod cl:initialize-instance :after ((m <GetArmState_Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetArmState_Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<GetArmState_Command> is deprecated: use dual_arm_msgs-msg:GetArmState_Command instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <GetArmState_Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:command-val is deprecated.  Use dual_arm_msgs-msg:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetArmState_Command>)))
  ...
  "dual_arm_msgs/GetArmState_Command")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetArmState_Command)))
  "Returns string type for a message object of type 'GetArmState_Command"
  "dual_arm_msgs/GetArmState_Command")
