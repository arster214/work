...
(defsystem "dual_arm_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "Arm_Current_State copy" :depends-on ("_package_Arm_Current_State copy"))
    (:file "_package_Arm_Current_State copy" :depends-on ("_package"))
    ...
    (:file "Arm_Pose_Euler" :depends-on ("_package_Arm_Pose_Euler"))
    (:file "_package_Arm_Pose_Euler" :depends-on ("_package"))
    ...
    (:file "CarteFdPose" :depends-on ("_package_CarteFdPose"))
    (:file "_package_CarteFdPose" :depends-on ("_package"))
    ...
    (:file "GetArmState_Command copy" :depends-on ("_package_GetArmState_Command copy"))
    (:file "_package_GetArmState_Command copy" :depends-on ("_package"))
    ...
    (:file "MoveJ_PO" :depends-on ("_package_MoveJ_PO"))
    (:file "_package_MoveJ_PO" :depends-on ("_package"))
