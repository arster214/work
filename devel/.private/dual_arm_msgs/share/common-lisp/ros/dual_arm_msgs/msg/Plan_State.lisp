...
(cl:defmethod cl:initialize-instance :after ((m <Plan_State>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Plan_State)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Plan_State> is deprecated: use dual_arm_msgs-msg:Plan_State instead.")))
