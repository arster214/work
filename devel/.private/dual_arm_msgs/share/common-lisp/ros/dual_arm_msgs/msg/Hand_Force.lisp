...
(cl:defmethod cl:initialize-instance :after ((m <Hand_Force>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hand_Force)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Hand_Force> is deprecated: use dual_arm_msgs-msg:Hand_Force instead.")))

(cl:ensure-generic-function 'hand_force-val :lambda-list '(m))
(cl:defmethod hand_force-val ((m <Hand_Force>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:hand_force-val is deprecated.  Use dual_arm_msgs-msg:hand_force instead.")
  (hand_force m))
