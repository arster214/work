...
(cl:defmethod cl:initialize-instance :after ((m <Joint_Teach>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joint_Teach)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Joint_Teach> is deprecated: use dual_arm_msgs-msg:Joint_Teach instead.")))

(cl:ensure-generic-function 'teach_joint-val :lambda-list '(m))
(cl:defmethod teach_joint-val ((m <Joint_Teach>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:teach_joint-val is deprecated.  Use dual_arm_msgs-msg:teach_joint instead.")
  (teach_joint m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <Joint_Teach>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:direction-val is deprecated.  Use dual_arm_msgs-msg:direction instead.")
  (direction m))

(cl:ensure-generic-function 'v-val :lambda-list '(m))
(cl:defmethod v-val ((m <Joint_Teach>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:v-val is deprecated.  Use dual_arm_msgs-msg:v instead.")
  (v m))
