...
(cl:defmethod cl:initialize-instance :after ((m <Joint_Step>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joint_Step)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Joint_Step> is deprecated: use dual_arm_msgs-msg:Joint_Step instead.")))
...
(cl:defmethod step_angle-val ((m <Joint_Step>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:step_angle-val is deprecated.  Use dual_arm_msgs-msg:step_angle instead.")
  (step_angle m))
