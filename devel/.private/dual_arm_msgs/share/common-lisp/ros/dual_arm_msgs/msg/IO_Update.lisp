...
(cl:defmethod cl:initialize-instance :after ((m <IO_Update>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IO_Update)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<IO_Update> is deprecated: use dual_arm_msgs-msg:IO_Update instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <IO_Update>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:type-val is deprecated.  Use dual_arm_msgs-msg:type instead.")
  (type m))
