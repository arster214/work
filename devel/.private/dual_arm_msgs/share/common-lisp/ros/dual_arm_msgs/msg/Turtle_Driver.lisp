...
(cl:defmethod cl:initialize-instance :after ((m <Turtle_Driver>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Turtle_Driver)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Turtle_Driver> is deprecated: use dual_arm_msgs-msg:Turtle_Driver instead.")))

(cl:ensure-generic-function 'message_type-val :lambda-list '(m))
(cl:defmethod message_type-val ((m <Turtle_Driver>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:message_type-val is deprecated.  Use dual_arm_msgs-msg:message_type instead.")
  (message_type m))

(cl:ensure-generic-function 'robot_mac_address-val :lambda-list '(m))
(cl:defmethod robot_mac_address-val ((m <Turtle_Driver>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:robot_mac_address-val is deprecated.  Use dual_arm_msgs-msg:robot_mac_address instead.")
  (robot_mac_address m))

(cl:ensure-generic-function 'vx-val :lambda-list '(m))
(cl:defmethod vx-val ((m <Turtle_Driver>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:vx-val is deprecated.  Use dual_arm_msgs-msg:vx instead.")
  (vx m))

(cl:ensure-generic-function 'vy-val :lambda-list '(m))
(cl:defmethod vy-val ((m <Turtle_Driver>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:vy-val is deprecated.  Use dual_arm_msgs-msg:vy instead.")
  (vy m))

(cl:ensure-generic-function 'vtheta-val :lambda-list '(m))
(cl:defmethod vtheta-val ((m <Turtle_Driver>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:vtheta-val is deprecated.  Use dual_arm_msgs-msg:vtheta instead.")
  (vtheta m))
