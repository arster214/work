...
(cl:defmethod cl:initialize-instance :after ((m <Hand_Seq>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hand_Seq)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Hand_Seq> is deprecated: use dual_arm_msgs-msg:Hand_Seq instead.")))

(cl:ensure-generic-function 'seq_num-val :lambda-list '(m))
(cl:defmethod seq_num-val ((m <Hand_Seq>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:seq_num-val is deprecated.  Use dual_arm_msgs-msg:seq_num instead.")
  (seq_num m))
