...
(cl:defmethod cl:initialize-instance :after ((m <Socket_Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Socket_Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Socket_Command> is deprecated: use dual_arm_msgs-msg:Socket_Command instead.")))
