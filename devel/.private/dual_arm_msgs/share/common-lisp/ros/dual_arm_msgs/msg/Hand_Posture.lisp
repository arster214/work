...
(cl:defmethod cl:initialize-instance :after ((m <Hand_Posture>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hand_Posture)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Hand_Posture> is deprecated: use dual_arm_msgs-msg:Hand_Posture instead.")))

(cl:ensure-generic-function 'posture_num-val :lambda-list '(m))
(cl:defmethod posture_num-val ((m <Hand_Posture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:posture_num-val is deprecated.  Use dual_arm_msgs-msg:posture_num instead.")
  (posture_num m))
