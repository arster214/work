...
(cl:defmethod cl:initialize-instance :after ((m <Gripper_Set>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gripper_Set)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Gripper_Set> is deprecated: use dual_arm_msgs-msg:Gripper_Set instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Gripper_Set>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:position-val is deprecated.  Use dual_arm_msgs-msg:position instead.")
  (position m))
