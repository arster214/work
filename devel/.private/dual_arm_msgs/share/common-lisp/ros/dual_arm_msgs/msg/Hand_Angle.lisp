...
(cl:defmethod cl:initialize-instance :after ((m <Hand_Angle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hand_Angle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Hand_Angle> is deprecated: use dual_arm_msgs-msg:Hand_Angle instead.")))

(cl:ensure-generic-function 'hand_angle-val :lambda-list '(m))
(cl:defmethod hand_angle-val ((m <Hand_Angle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:hand_angle-val is deprecated.  Use dual_arm_msgs-msg:hand_angle instead.")
  (hand_angle m))
