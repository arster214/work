...
(cl:defmethod cl:initialize-instance :after ((m <Ort_Teach>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Ort_Teach)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Ort_Teach> is deprecated: use dual_arm_msgs-msg:Ort_Teach instead.")))

(cl:ensure-generic-function 'teach_type-val :lambda-list '(m))
(cl:defmethod teach_type-val ((m <Ort_Teach>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:teach_type-val is deprecated.  Use dual_arm_msgs-msg:teach_type instead.")
  (teach_type m))
