...
(cl:defmethod cl:initialize-instance :after ((m <Gripper_Pick>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gripper_Pick)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Gripper_Pick> is deprecated: use dual_arm_msgs-msg:Gripper_Pick instead.")))
