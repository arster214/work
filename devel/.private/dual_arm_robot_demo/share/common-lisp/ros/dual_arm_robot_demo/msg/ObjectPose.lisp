...
(cl:in-package dual_arm_robot_demo-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_robot_demo-msg:<ObjectPose> is deprecated: use dual_arm_robot_demo-msg:ObjectPose instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <ObjectPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_robot_demo-msg:x-val is deprecated.  Use dual_arm_robot_demo-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <ObjectPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_robot_demo-msg:y-val is deprecated.  Use dual_arm_robot_demo-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <ObjectPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_robot_demo-msg:z-val is deprecated.  Use dual_arm_robot_demo-msg:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObjectPose>)))
  ...
  "dual_arm_robot_demo/ObjectPose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectPose)))
  "Returns string type for a message object of type 'ObjectPose"
  "dual_arm_robot_demo/ObjectPose")
